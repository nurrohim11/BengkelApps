...
import com.izzaweb.bengkel.Ui.BookingActivity;
import com.izzaweb.bengkel.Ui.DataBengkelActivity;
import com.izzaweb.bengkel.Ui.DetailsBengkel;
import com.izzaweb.bengkel.Ui.HistoryActivity;
import com.izzaweb.bengkel.Ui.ProfileActivity;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            ...
            Intent t= new Intent(this, HistoryActivity.class);
            startActivity(t);

        } else if (id == R.id.nav_booking) {
            Intent b= new Intent(this, DataBengkelActivity.class);
            startActivity(b);
